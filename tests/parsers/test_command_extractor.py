...
import pytest
@pytest.mark.asyncio
async def test_parse_command_with_prefix():
...
@pytest.mark.asyncio
async def test_parse_command_without_prefix_private():
    body = "test"
    command, args = parse_command_from_body(body, is_group=False)
...
@pytest.mark.asyncio
async def test_parse_command_group_with_prefix():
    body = "@bot help"
...
@pytest.mark.asyncio
async def test_parse_command_invalid():
