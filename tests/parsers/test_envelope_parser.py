...
import pytest
@pytest.mark.asyncio
async def test_parse_sender():
    message = "Envelope\nfrom: +1234567890\nBody: Hello"
    sender = parse_sender(message)
    assert sender == "+1234567890"

@pytest.mark.asyncio
async def test_parse_body():
