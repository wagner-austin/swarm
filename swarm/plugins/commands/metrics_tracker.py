...
class MetricsTracker(commands.Cog):
    ...
    async def _latency_loop(self) -> None:
        """Update the swarm latency gauge every 30 s while the swarm is running.

        The loop exits automatically once the swarm is closed or the task is
